...
namespace PlayerWeaponsManagerCore
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        public Action<WeaponController> OnSwitchedToWeapon;
        public Action<WeaponController, int> OnAddedWeapon;
        public Action<WeaponController, int> OnRemovedWeapon;
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerStateMachine, PlayerWeaponsManager>(
                PlayerStateMachine.Instance, this, gameObject);
        ...
        {
            PlayerStateMachine.Instance.PlayerCamera.fieldOfView = fov;
        ...
        void UpdateWeaponAiming()
        {
            if (m_WeaponSwitchState == WeaponSwitchState.Up)
            {
                ...
                if (IsAiming && activeWeapon)
                {
                    ...
                    SetFov(Mathf.Lerp(PlayerStateMachine.Instance.PlayerCamera.fieldOfView,
                ...
                else
                {
                    ...
                    SetFov(Mathf.Lerp(PlayerStateMachine.Instance.PlayerCamera.fieldOfView, DefaultFov,
                        AimingAnimationSpeed * Time.deltaTime));
                }
            }
        }
        ...
        void UpdateWeaponBob()
        {
            if (Time.deltaTime > 0f)
            {
                Vector3 playerCharacterVelocity =
                    (PlayerStateMachine.Instance.transform.position - m_LastCharacterPosition) / Time.deltaTime;

                // calculate a smoothed weapon bob amount based on how close to our max grounded movement velocity we are
                float characterMovementFactor = 0f;
                if (PlayerStateMachine.Instance.IsGrounded)
                {
                    characterMovementFactor =
                        Mathf.Clamp01(playerCharacterVelocity.magnitude /
                                      (PlayerStateMachine.Instance.MaxSpeedOnGround *
                                       PlayerStateMachine.Instance.SprintSpeedModifier));
                }
                ...
                m_LastCharacterPosition = PlayerStateMachine.Instance.transform.position;
            }
        }
